...
const Vision = () => (
    ...
    <Col md={6}>
      <Image
        className="vision-back-img" src="https://www.freeiconspng.com/uploads/iphone-6-png-10.png" responsive />
        <Image
          className="vision-front-img" src="https://www.freeiconspng.com/uploads/iphone-6-png-10.png" responsive />
    </Col>
  </Row>
);
