...
const Identity = () => (
  <div className="identity-container" id="technology">
    ...
    <h3>I-C-It helps you share your life with your communities, one post at a time.</h3>
    <iframe width="750" height="450" src="https://www.youtube.com/embed/znz8o-boH0E" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    <h3>Our users value their privacy and I-C-It's innovative software. We frequently look at user feedback and release new versions of the application</h3>
  </div>
